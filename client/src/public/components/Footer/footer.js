...
function footer() {
  return (
   ...
   // <footer className="text-center text-lg-start bg-light text-muted" style={{padding-bottom:(10 rem)}; {padding-bottom:(5rem)}}>
<footer className="text-center text-lg-start bg-light text-muted" style = {{paddingBottom: "6rem"}}>
